...
public class DashedRoundRectangleIcon implements Icon {
	public int width, height, round;
	public String text;
	
	public DashedRoundRectangleIcon(int width, int height, int round, String text) {
		this.width  = width;
		this.height = height;
		this.round = round;
		this.text = text;
	...
	public DashedRoundRectangleIcon(int size) {
	...
	public static void main(String[] args) {
		...
		JFrame f = new JFrame();
		f.setContentPane(new JLabel(new DashedRoundRectangleIcon(128)));
